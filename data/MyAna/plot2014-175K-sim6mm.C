...
plot2014_175K_sim6mm()
{
 ...
 gROOT->ForceStyle();
  ...
  sprintf (title1, "musr_200600.root.root");
  sprintf (title2, "musr_1750600.root.root");
  sprintf (title3, "musr_1750602.root.root");
...
//  h[i] ->Scale(h[0]->GetBinContent(101)/h[i]->GetBinContent(101));
  ...
  leg_hist->AddEntry (h[0], "SiO2-porous/SiN-6mm/20K (sim)", "l");
  leg_hist->AddEntry (h[1], "SiO2-porous/SiN-6mm/175K (sim,adsorption)", "l");
  leg_hist->AddEntry (h[2], "SiO2-porous/SiN-6mm/175K (sim,reflection)", "l");
