...
plot2014_250K_sim6mm()
{
 ...
 gROOT->ForceStyle();
  ...
  sprintf (title2, "musr_2500600.root.root");
  sprintf (title3, "musr_2500602.root.root");
...
//  h[i] ->Scale(h[0]->GetBinContent(101)/h[i]->GetBinContent(101));
  ...
  leg_hist->AddEntry (h[1], "SiO2-porous/SiN-6mm/250K (sim,adsorption)", "l");
  leg_hist->AddEntry (h[2], "SiO2-porous/SiN-6mm/250K (sim,reflection)", "l");
