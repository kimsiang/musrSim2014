...
plot2014_175K_sim2mm()
{
 ...
 gStyle->SetOptStat(0000);
  ...
  sprintf (title2, "musr_1750200.root.root");
  sprintf (title3, "musr_1750202.root.root");
...
//  h[i] ->Scale(h[0]->GetBinContent(101)/h[i]->GetBinContent(101));
  ...
  leg_hist->AddEntry (h[1], "SiO2-porous/SiN-2mm/175K (sim,adsorption)", "l");
  leg_hist->AddEntry (h[2], "SiO2-porous/SiN-2mm/175K (sim,reflection)", "l");
