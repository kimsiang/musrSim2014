...
plot2014_100K_sim1mm()
{
 ...
 gROOT->ForceStyle();
  ...
  sprintf (title2, "musr_1000200.root.root");
  sprintf (title3, "musr_1000202.root.root");
...
//  h[i] ->Scale(h[0]->GetBinContent(101)/h[i]->GetBinContent(101));
  ...
  leg_hist->AddEntry (h[0], "SiO2-porous/SiN-1mm/20K (sim)", "l");
  leg_hist->AddEntry (h[1], "SiO2-porous/SiN-1mm/100K (sim,adsorption)", "l");
  leg_hist->AddEntry (h[2], "SiO2-porous/SiN-1mm/100K (sim,reflection)", "l");
