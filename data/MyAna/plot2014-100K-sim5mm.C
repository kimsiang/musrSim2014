...
plot2014_100K_sim6mm()
{
 ...
 gROOT->ForceStyle();
  ...
  sprintf (title2, "musr_1000600.root.root");
  sprintf (title3, "musr_1000602.root.root");
...
//  h[i] ->Scale(h[0]->GetBinContent(101)/h[i]->GetBinContent(101));
  ...
  leg_hist->AddEntry (h[1], "SiO2-porous/SiN-6mm/100K (sim,adsorption)", "l");
  leg_hist->AddEntry (h[2], "SiO2-porous/SiN-6mm/100K (sim,reflection)", "l");
